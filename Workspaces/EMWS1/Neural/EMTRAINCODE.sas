...
GRP_Age GRP_BasementType GRP_Baths GRP_CentralAir GRP_FirePlace
GRP_G_ConstructionType GRP_GarageSize GRP_TotalArea SalePrice);
run;
*------------------------------------------------------------* ;
...
%macro DMDBClass;
   ...
   GRP_FirePlace(ASC) GRP_G_ConstructionType(ASC) GRP_GarageSize(ASC)
   GRP_TotalArea(ASC)
%mend DMDBClass;
*------------------------------------------------------------* ;
...
%macro ORDINPUTS;
    GRP_Age GRP_BasementType GRP_Baths GRP_CentralAir GRP_FirePlace
   GRP_G_ConstructionType GRP_GarageSize GRP_TotalArea
%mend ORDINPUTS;
*------------------------------------------------------------*;
...
train tech=NONE;
code file="J:\CIS-445-Project-4-master\CIS-445-Project-4-master\Project_4\Workspaces\EMWS1\Neural\SCORECODE.sas"
group=Neural
;
;
code file="J:\CIS-445-Project-4-master\CIS-445-Project-4-master\Project_4\Workspaces\EMWS1\Neural\RESIDUALSCORECODE.sas"
group=Neural
residual
;
;
